# =============================================================================
# Script 13 (control comparison): the divergence by lung size, arm by arm
...
# test it, reading only the aggregate tables 13_biotrauma_report.R wrote:
#
...
#
# Usage: PBWPFVC_JM_GRID=daily PBWPFVC_JM_HORIZON=7 Rscript code/13_control_comparison.R
# =============================================================================
...
if (config$cohort != "imv" || nzchar(Sys.getenv("PBWPFVC_SITE_NAME", "")))
  stop("13_control_comparison.R reads every cohort's folder itself: unset PBWPFVC_COHORT and PBWPFVC_SITE_NAME")
base_site <- config$site_name
source(here("code", "13_biotrauma_grid.R"))   # h_suffix
...
message("=== 13_control_comparison (", MOD_FORM, ", ", h_suffix, ", ", base_site, "): ", nrow(arms), " arms ===")
...
message("13_control_comparison complete: ", nrow(comparison), " rows -> ", final_dir)
