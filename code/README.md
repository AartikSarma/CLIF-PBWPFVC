...
| `28_pre_period_placebo.R` | figure 4 | The pre-trend check: the lung-size divergence in the days before the first IMV record (panel `jm_pre_7d`, from `21`), beside the joint model's post-intubation rate; a runner step | `jm_pre_placebo_` |
