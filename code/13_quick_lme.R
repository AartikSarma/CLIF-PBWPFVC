...
#       exposure (13_biotrauma_grid.R): the contrast at the horizon identified
...
# =============================================================================
out <- map_dfr(names(EXPOS), function(EXPO) map_dfr(QUICK_HOURS, function(hh) {
  d <- window_data(d_all, hh)
...
message("13_quick_lme complete -> ", final_dir)
