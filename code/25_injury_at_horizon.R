# =============================================================================
# Script 25 (injury at horizon): is a lower PFVC, at a given VT/PBW, associated
...
#          (20_biotrauma_grid.R): the size effect identified through each GLI
...
source(here("code", "20_biotrauma_grid.R"))   # pfvc_channels(), channels_equal_p()
...
message("=== 25_injury_at_horizon: marker ", MARKER, ", horizons ", paste(HORIZONS, collapse = "/"), " h, site ", site_name, " ===")
...
message("25_injury_at_horizon complete -> ", final_dir)
