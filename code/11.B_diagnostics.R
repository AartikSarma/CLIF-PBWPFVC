# =============================================================================
# Script 11.B: Diagnostics -- positivity / weights / balance (§10g, 10g2, 10g3, 10g4)
#              + the two write-free objects computed in common (panel drops, struct excl)
# =============================================================================
# Sources the shared common file (10_tte_common.R). Writes the diagnostic CSVs/PDF and
...
# caveat made visible on the thesis's own axis, alongside the discordance subgroup RD (11.A).
