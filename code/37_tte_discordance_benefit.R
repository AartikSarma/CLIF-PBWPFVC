# =============================================================================
# Script 37.X: Does the strain-limiting (PFVC-guided) policy benefit the MISDOSED most?
...
#      the actual "benefits the misdosed MORE" statistic. 35_tte_primary bootstraps each subgroup RD
...
#
# Reuses the PRIMARY design (des/long_all from 30_tte_common via the engine loader); the
# only new fit is a focused cluster bootstrap for the per-tertile RDs + the gradient.
# Synthetic survival is simulated => plumbing only. Registered at the end of 32_tte_run_all.
# =============================================================================
...
#   (2) SOFA CORRECTION -- the 37_tte_discordance_benefit balance read showed the IPCW leaves a residual baseline-
...
message("37_tte_discordance_benefit discordance-HTE bootstrap (", N_BOOT, " reps across ", n_cores_used,
...
# --- discordance-STRATIFIED E-value (35_tte_primary's E-value is overall only) -------------------
...
# 35_tte_primary (textbook E-value is for a point exposure; here it indexes censoring-confounding). If the
...
message("37_tte_discordance_benefit continuous CATE bootstrap (", N_BOOT, " reps across ", n_cores_used, " core(s)) ...")
...
# =============================================================================
# The primary IPC weights are fit ONCE on the full cohort; 37_tte_discordance_benefit then estimates RDs within
...
# C_LOW x C_HIGH sweep -- were moved to code/supplement/tte_sensitivities.R (lead-site/supplement) to keep
...
# Console summary
# =============================================================================
cat("\n=== 37_tte_discordance_benefit strain-limiting benefit by PBW/PFVC discordance (misdosed = Discordant; SOFA-adjusted, standardized) ===\n")
...
cat("\n    (trim x weight-cap and strain-threshold C_LOW x C_HIGH sweeps -> code/supplement/tte_sensitivities.R)\n")
