# =============================================================================
# 11_sens_thresholds: strain-threshold sweep (vary C_LOW and C_HIGH around the primary)
# =============================================================================
...
# gradient survive other clinically-defensible ceilings? Point estimates only (primary CIs: 11.X).
...
message("11_sens_thresholds: strain-threshold sweep -- rebuilding ", length(ceiling_grid), " designs ...")
