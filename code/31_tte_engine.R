# =============================================================================
# Script 31 (engine loader): a config-aware cache/guard in front of 30_tte_common.R
# =============================================================================
# Iteration speed-up AND a correctness guard. The 11.* leaves build on the shared engine
# in 30_tte_common.R (parquet reads, the SpO2->FiO2 rolling join, the IPCW propensity
...
#
# Source THIS instead of 30_tte_common.R, and source it UNCONDITIONALLY (do NOT wrap it in
...
#   * miss / changed    -- sources 30_tte_common.R and writes the snapshot
...
# 30_tte_common.R, so both must be established here too (run on every source -- idempotent).
...
.tte_common  <- here("code", "30_tte_common.R")
