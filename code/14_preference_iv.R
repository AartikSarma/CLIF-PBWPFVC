# =============================================================================
# Script 14: practice-variation instrument for the strain-limiting strategy
# PBW vs PFVC Replication Using CLIF Data
# =============================================================================
# The target-trial emulation (script 10) estimates the 60-day mortality effect of
...
# Usage: Rscript code/14_preference_iv.R   (PBWPFVC_TTE_CLOW=11, PBWPFVC_IV_DAYS=3,
...
message("14_preference_iv complete -> ", final_dir)
