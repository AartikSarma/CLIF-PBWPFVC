# =============================================================================
# Script 11_run_all: PRIMARY TTE refresh -- source the engine ONCE, then the primary leaves.
# =============================================================================
...
#
#   11.M_ceiling_tte.R          PRIMARY: the normalizer head-to-head on tidal volume --
...
#
# Every leaf sources 10_tte_engine.R unconditionally; the engine restores the cached build for
# this site, so the repeat sources are cheap. The mechanical-power family of 11.M and the
# sensitivity suite (11_sensitivities.R) are lead-site supplements, not part of this bundle.
#
