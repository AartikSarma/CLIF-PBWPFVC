# =============================================================================
# 33_tte_ceiling_cap: TTE of [PBW ceiling + PFVC safety cap] vs [PBW ceiling alone] (cap-on-top)
# =============================================================================
...
# tertile is the design's negative control; 33_tte_ceiling_diagnostics.R tests whether its RD is a
