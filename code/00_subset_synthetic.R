# =============================================================================
# Script 00_subset_synthetic: a smaller synthetic CLIF dataset for fast test loops
# =============================================================================
#
...
#
#   Rscript code/00_subset_synthetic.R --frac 0.3 --seed 1
#   PBWPFVC_TABLES_PATH=~/Research/synthetic_clif/synth_clif_10k_sub30 \
#     Rscript code/01_cohort_identification.R      # and so on for 02, 03, 11_run_all
#
...
if (!identical(config$site_name, "synthetic_clif"))
  stop("00_subset_synthetic.R only subsets the synthetic site; config site_name is '",
       config$site_name, "'.")
if (!identical(config$file_type, "parquet"))
  stop("00_subset_synthetic.R handles parquet folders only.")
