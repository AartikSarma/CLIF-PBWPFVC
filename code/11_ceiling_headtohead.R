# =============================================================================
# 11_ceiling_headtohead: TTE of a PFVC-anchored vs a PBW-anchored ceiling (bite-matched)
# =============================================================================
...
# primary interval comes from the weight-refit bootstrap in 11_ceiling_diagnostics.R.
