# =============================================================================
# 11_sens_censoring: common-support trim x day-weight cap sweep (at the primary ceilings)
# =============================================================================
...
# artifact. Point estimates only (primary CIs: 11.X). Outputs tte_ccw_disc_censoring_sweep_<site>.
# =============================================================================
...
message("11_sens_censoring: censoring (trim x cap) sweep -- rebuilding ", length(cens_grid), " designs ...")
