# =============================================================================
# tte_sens_weightmodel: S/F weight-model robustness (richer deviation model + weight-timing)
# =============================================================================
# Two reads on the residual lagged-S/F imbalance 37_tte_discordance_benefit's time-varying balance flagged:
...
# 37_tte_discordance_benefit's time-varying balance found lagged S/F still predicts deviation AFTER weighting in the
...
# weighted deviation ~ lagged-confounder S/F balance for one design (strain arm, days 2-7) -- 37_tte_discordance_benefit D2
...
message("tte_sens_weightmodel: richer weight-model (S/F) sensitivity -- rebuilding rich design ...")
...
# 37_tte_discordance_benefit D2 weighted each eligible day t by cumw(t) -- which includes day t's OWN deviation factor
