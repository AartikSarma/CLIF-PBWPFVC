# =============================================================================
# Supplement: Does PBW-based dosing concentrate HARMFUL mechanical-stress
...
# iv_height_policy (height-IV) separately shows absolute stress causally raises mortality.
...
message("xsec_subgroup_harm_exposure complete.")
