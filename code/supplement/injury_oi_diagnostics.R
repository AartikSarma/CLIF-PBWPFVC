# =============================================================================
# Supplement (OI diagnostics): is an oxygenation-index signal the lung, or the
...
#
# Needs a panel carrying map_aw / oi / osi (21_biotrauma_panel.R, any grid):
#   PBWPFVC_JM_HORIZON_H=72 Rscript code/21_biotrauma_panel.R
# Usage:
#   PBWPFVC_JM_HORIZON_H=72 Rscript code/supplement/injury_oi_diagnostics.R
#
...
if (!all(c("map_aw", "oi", "osi") %in% names(long)))
  stop("this panel predates the oxygenation indices: rebuild it with the current 21_biotrauma_panel.R")
...
message("=== injury_oi_diagnostics (", h_suffix, " panel): ", nrow(d_all), " patient-periods, ",
...
message("\ninjury_oi_diagnostics complete -> ", final_dir)
