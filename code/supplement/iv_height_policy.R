# =============================================================================
# Supplement: Height-instrumented PFVC-anchoring policy (modified treatment policy)
...
# near-deterministic in demographics (xsec_subgroup_harm_exposure positivity: c~0.996, ESS~0),
...
# mis-sizing -- i.e. VT/PFVC is the structural dose -- which xsec_dose_heterogeneity
...
message("iv_height_policy complete.")
