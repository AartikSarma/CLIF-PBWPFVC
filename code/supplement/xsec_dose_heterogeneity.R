# =============================================================================
# Supplement: Dose heterogeneity under PBW dosing + VT/PFVC as the structural dose
...
# is also the identifying assumption the height-IV policy (iv_height_policy) relies on
...
# =============================================================================
# 8b. Analytic frame + subgroup factors (same construction as xsec_subgroup_harm_exposure)
# =============================================================================
...
# that effect is iv_height_policy's height-IV job).
...
message("xsec_dose_heterogeneity complete.")
