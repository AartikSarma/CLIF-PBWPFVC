# =============================================================================
# Supplement: Age-correction sensitivity bracket (PBW / FVC_age25 / PFVC)
# =============================================================================
...
cat(sprintf("xsec_age_correction_bracket: VT cohort %d; MP %d; Ers %d; in-hospital mortality %.1f%%\n",
...
# ---- console summary --------------------------------------------------------
cat("\n=== xsec_age_correction_bracket age-correction bracket (PBW / FVC_age25 / PFVC) ===\n")
