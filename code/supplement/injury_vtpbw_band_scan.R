# =============================================================================
# Supplement (band scan): who enters the cohort if the VT/PBW gate is widened?
# =============================================================================
...
# Usage: Rscript code/supplement/injury_vtpbw_band_scan.R   (PBWPFVC_BAND_LOWER="4,4.5,5,5.5,6";
...
message("injury_vtpbw_band_scan complete -> ", final_dir)
