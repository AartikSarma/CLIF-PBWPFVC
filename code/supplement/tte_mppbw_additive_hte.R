# =============================================================================
# Supplement.Y: CATE of an ADDITIVE MP/PBW power-reduction MTP, by PBW/PFVC discordance + PFVC
# =============================================================================
# The mechanical-power, LMTP-estimated SIBLING to 37_tte_discordance_benefit. 37_tte_discordance_benefit is a clone-censor-weight TTE of a
...
# most in exactly the patients PBW over-sizes -- the MP analogue of the 37_tte_discordance_benefit discordance gradient.
#
...
# discordance axis exactly as the 37_tte_discordance_benefit VT/PFVC ceiling is, and the resulting discordance
...
# the VT titration. This is the POWER-axis analogue of the VT co-primary (34_tte_titration): an
...
# against the dosing hypothesis. Standalone supplement -- NOT in 32_tte_run_all. Synthetic mortality
...
if (any(!.avail)) message("tte_mppbw_additive_hte: dropping unavailable learners: ", paste(LRN[!.avail], collapse = ", "))
LRN <- unique(c(LRN[.avail], "SL.glm", "SL.mean"))
# STABLE treatment-density learner (matches 34_tte_titration): a forest/gam estimating the conditional
...
cat(sprintf("tte_mppbw_additive_hte: %d patients; PBW/PFVC discordance median %.2f, PFVC median %.2f L; ADDITIVE delta %.3f (J/min)/kg, floor %.2f, K %d, folds %d\n",
...
cat("\n=== tte_mppbw_additive_hte continuous CATE of an ADDITIVE MP/PBW reduction, by PFVC-derived modifiers ===\n")
