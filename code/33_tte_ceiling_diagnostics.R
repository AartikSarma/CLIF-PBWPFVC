# =============================================================================
# 33_tte_ceiling_diagnostics: the PRIMARY interval (weight-refit bootstrap) + the placebo contrast
# =============================================================================
# The design pieces (33_tte_ceiling_headtohead.R / 33_tte_ceiling_cap.R) use the fixed-weight cluster
...
run_diagnostics <- function(DIAG) {
  ...
  message("33_tte_ceiling_diagnostics [", FAM, "]: weight-REFIT bootstrap for design '", DIAG, "' (", N_REFIT,
  ...
  cat(sprintf("\n=== 33_tte_ceiling_diagnostics [%s] (design '%s') ===\n", FAM, DIAG))
